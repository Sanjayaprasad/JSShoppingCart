...
db.products.insert({"itemname":"Adidas", "itemprice":500, "quantity":25, "sizes":"6,7,8,9"});
db.products.insert({"itemname":"Bata", "itemprice":499, "quantity":20, "sizes":"7,8,9"});
...
db.products.insert({"itemname":"TommyHilfiger", "itemprice":5499, "quantity":15, "sizes":"7,8,9"});